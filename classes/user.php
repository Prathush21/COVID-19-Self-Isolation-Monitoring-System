...
abstract class User{
    ...
    abstract public function create($fields = array());
    // {
    ...
    abstract public function update($fields = array(),$uname);
    // {
    ...
    abstract public function getDetails($uname);
    abstract public static function getInstance($uname);
